    ...
    <div>
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          <div className="">
            <p className="text-base leading-7 text-[var(--gray-600)] mb-6">Carrier raktérhűtők értékesítés, beépítés és szerviz. Hivatalos Carrier Transicold márkaszerviz és alkatrész forgalmazó. Daikin hűtőberendezések javítása is.</p>
          </div>
        </div>
      </section>
      </AnimateOnScroll>
