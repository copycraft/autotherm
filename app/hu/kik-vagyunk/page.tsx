    ...
    <div>
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          <p className="text-[var(--gray-600)] mb-6 max-w-3xl">1992-ben, Csurgó László és Peter Knerer alapították az Autotherm Kft.-t azzal a céllal, hogy a Carrier hűtőberendezéseket meghonosítsák a magyar piacon. 1995-től a Thermo King szerviz is a portfóliónk része lett — mára Dél-Magyarország meghatározó raktérhűtő szervize vagyunk.</p>
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          ...
          <p className="text-[var(--gray-600)] mb-6 max-w-3xl mx-auto text-center">Napról napra jobbnak lenni abban, amit csinálunk. Folyamatosan fejlesztjük gyártási folyamatainkat és eszközeinket, hogy gyorsabban és korszerűbben szolgálhassuk ki ügyfeleinket. Ahogy Henry Ford mondta: &ldquo;Többet tenni a világért, mint amennyit a világ tesz érted — ez a siker.&rdquo;</p>
        </div>
      </section>
      </AnimateOnScroll>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={s.label} className="text-center p-8 bg-white rounded-xl border border-[var(--gray-200)] shadow-sm">
                <div className="text-4xl font-bold text-[var(--primary)] mb-2">{s.number}</div>
                <div className="text-[var(--gray-400)]">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
