...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: getPageMeta("hu", "/hu/hutoauto-blog").title,
    description: getPageMeta("hu", "/hu/hutoauto-blog").description,
    keywords: getPageMeta("hu", "/hu/hutoauto-blog").keywords,
  };
}
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          ...
          <div className="max-w-4xl mx-auto">
            {posts.length === 0 && <p className="text-[var(--gray-600)]">Még nincsenek bejegyzések.</p>}
            {posts.map((post) => (
              <article key={post.id} className="blog-post border-b border-[var(--gray-200)] pb-8 mb-8">
                <h2><span className="">{post.hu_title}</span></h2>
