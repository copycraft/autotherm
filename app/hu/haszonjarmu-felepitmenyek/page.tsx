...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: getPageMeta("hu", "/hu/haszonjarmu-felepitmenyek").title,
    description: getPageMeta("hu", "/hu/haszonjarmu-felepitmenyek").description,
    keywords: getPageMeta("hu", "/hu/haszonjarmu-felepitmenyek").keywords,
  };
}
    ...
    <div>
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          <div className="">
            <p className="text-base leading-7 text-[var(--gray-600)] mb-6">3,5 tonnás alvázakra épített dobozos felépítmények széles választéka. Alumínium doboz, hűtős doboz, platós-ponyvás és speciális felépítmények.</p>
          </div>
        </div>
      </section>
      </AnimateOnScroll>
