...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return { title: "Who are we - Autotherm Ltd." };
}
      ...
      <section className="content-section black-text white-bg top-spacing-big bottom-spacing-big">
        <div className="wrap-column">
          <div className="content-column1">
            <p className="text-base leading-7 text-[#666] mb-6">Our company was founded in 1992 under the name Autotherm Ltd. The founders, László Csurgó and Dkfm. Peter Knerer established the company with the aim of introducing Carrier refrigeration equipment to the emerging Hungarian refrigerated market. Since 1995, we have also been performing Thermo King refrigeration unit repairs, becoming a leading refrigeration service center in Southern Hungary.</p>
            <p className="text-base leading-7 text-[#666] mb-6">Today we operate on 1500 m² with 4 production halls: two for vehicle body manufacturing and insulation, one for metal processing, and one for installation and servicing of refrigeration units. Our 33 employees work daily to impress our customers with our work and service.</p>
          </div>
        </div>
      </section>
      </AnimateOnScroll>
