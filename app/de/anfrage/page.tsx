...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return { title: "Kühlfahrzeugbau - Frischdienst und Tiefkühl Umbau. Preisanfrage" };
}
      ...
      <section className="content-section black-text white-bg top-spacing-big bottom-spacing-big">
        <div className="wrap-column">
          <div className="content-column1">
            <p className="text-base leading-7 text-[#666] mb-6">Teilen Sie Ihre Ideen mit uns - wir fügen unsere Erfahrung hinzu. Professionelles Engagement, Full-Service und branchenführende Geschwindigkeit mit 100% Geld-zurück-Garantie.</p>
          </div>
        </div>
      </section>
      </AnimateOnScroll>
