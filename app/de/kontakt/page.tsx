    ...
    <div>
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          <div className="">
            <p className="text-base leading-7 text-[var(--gray-600)] mb-6">Unser Team arbeitet für den Erfolg des Unternehmens. Professionelles Engagement, Full-Service und 100% Geld-zurück-Garantie. Kontaktieren Sie uns!</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div>
              <div className="p-8 border border-[var(--gray-200)] bg-white">
                ...
                <div className="contact-detail"><i className="fa fa-map-marker"></i><div><p className="font-bold">Adresse</p><p className="text-[var(--gray-600)]">6728 Szeged, Napos út 3., Ungarn</p></div></div>
                ...
                <div className="contact-detail"><i className="fa fa-clock-o"></i><div><p className="font-bold">Öffnungszeiten</p><p className="text-[var(--gray-600)]">Montag - Freitag 08:00-16:30</p></div></div>
              </div>
            </div>
            <div>
              <div className="p-8 border border-[var(--gray-200)] bg-white">
