...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: getPageMeta("ro", "/ro/cine-suntem-noi").title,
    description: getPageMeta("ro", "/ro/cine-suntem-noi").description,
    keywords: getPageMeta("ro", "/ro/cine-suntem-noi").keywords,
  };
}
    ...
    <div>
      ...
      <section className="content-section white-bg">
        <div className="wrap-column">
          <div className="">
            <p className="text-base leading-7 text-[var(--gray-600)] mb-6">Compania noastră a fost fondată în 1992 sub numele Autotherm SRL. Fondatorii, László Csurgó și Dkfm. Peter Knerer, au înființat compania cu scopul de a introduce echipamentele de refrigerare Carrier pe piața maghiară. Din 1995, efectuăm și reparații Thermo King, devenind centrul de service frigorific lider în Ungaria de Sud.</p>
            <p className="text-base leading-7 text-[var(--gray-600)] mb-6">Astăzi operăm pe 1500 m² cu 4 hale de producție. Cei 33 de angajați ai noștri lucrează zilnic pentru a impresiona clienții cu munca și serviciile noastre.</p>
          </div>
        </div>
      </section>
      </AnimateOnScroll>
